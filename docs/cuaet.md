...
slug: /
sidebar_position: 1
description: Как переехать в Канаду из Украины по программе CUAET. Информация, детали программы и чеклисты. Полезные ресурсы.
---
...
- Биометрию **НУЖНО** сдавать,тем кто ранее не сдавал биометрию именно для Канады. Это бесплатно.
    ...
    - После сдачи биометрии, начинается рассмотрение заявки: 
      1.  Сперва, приходит **biometric validity letter**(это не подтверждение о сдаче био, а информационное письмо о сроках действия биометрии).
      2.  Потом - **Original Passport request** с инструкциями (или [foil-less виза](foilless_visa.md) по email) и **Introduction letter**, с которым получаете **work permit** в аэропорту (эти письма приходят НЕ одновременно).
- Отправить паспорт на вклейку с foil-less можно до конца действия [foil-less visa](foilless_visa.md).

:::warning
❗️Обязательно❗️ проверяйте наличие пометки [**CUAET**](/img/cuaet_remark.jpg) в work permit, когда получаете его в аэропорту!
:::
...
## 💁 Полезная информация 
:::info
Новое! Добавили новую страничку с информацией про то как выучить или [подтянуть английский](english.md).
:::
...
✈️ [Фонд по финансированию перелетов](https://miles4migrants.org/) украинцев в Канаду скоро откроют (Miles4Migrants). [Подать заявку](https://miles4migrants.org/ukraine2canada/) можно уже сейчас, а так же изучить [FAQ](https://miles4migrants.org/faq/) программы.  
